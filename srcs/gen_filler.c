...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/08/14 15:32:25 by oyenyi-           #+#    #+#             */
/*   Updated: 2018/08/18 12:21:49 by tluzing          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	letter_nbr(t_map_info *p_info)
{
	...
	p_info->os_nbr = o_count;
	p_info->xs_nbr = x_count;
}
